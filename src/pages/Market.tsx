...
const Market = () => {
  ...
  const handleBet = (side: "yes" | "no") => {
    ...
    toast({
      ...
      description: `You're betting ${betAmount} on ${side.toUpperCase()}`
    });
  };
  ...
  const handlePlaceBet = () => {
    ...
    toast({
      title: "Bet Placed!",
      description: `You bet ${betAmount} on ${betSide.toUpperCase()}`
    });
  };
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-muted/50 p-4 rounded-md">
                      ...
                      <p className="text-lg font-semibold">${marketData.liquidity}</p>
                    </div>
                    <div className="bg-muted/50 p-4 rounded-md">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-sm font-medium mb-2 block">Amount to bet</label>
                  ...
                  <div className="bg-muted/50 p-3 rounded-md">
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-medium">${calculatePotentialProfit().toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span>Total return if correct</span>
                      <span className="font-medium">${(betAmount + calculatePotentialProfit()).toFixed(2)}</span>
                    </div>
                  </div>
                </div>
              </CardContent>
